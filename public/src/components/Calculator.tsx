  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await sendLead({
        ...
        message: userWishes ? `${details}\nРазмеры или пожелания: ${userWishes}` : details,
                ...
                <form onSubmit={handleFormSubmit} className="space-y-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-hidden focus:border-orange-500 resize-none shadow-2xs"
                    />
                  </div>
